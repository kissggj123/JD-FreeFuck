...
- __2021/4/24 22:01 `更新`__
  修复了上游脚本仓库面板安装脚本失效的问题（@kissggj123）
...
__ㅤㅤ`GitHub` 同步更新：[点击此处访问](https://github.com/kissggj123/JD-FreeFuck-Fix)__
...
* `kissggj123` 对任何脚本问题概不负责，包括但不限于由任何脚本错误导致的任何损失或损害。
...
#### __脚本一键部署：__
    bash <(curl -sSL https://raw.githubusercontent.com/kissggj123/JD-FreeFuck/main/install.sh)
